...
<body>
    ...
    <?php 
    #編集ボタンが押されていて、かつパスワードが正しいとき
        if (isset($_POST["edit"]) and $results[0]['pw'] == $edit_password){
    ?>
    ...
    <?php
    #編集ボタンが押されてないとき・押したけどパスワードが間違っていた時
        } else {
    ?>

    <form action="" method="post">
        <input type="hidden" name="option">
        <input type="text" name="name" placeholder="名前"><br> <!--コメントフォームの作成-->
